...
- **01 / 01L 대본 지침** — 챕터 구조와 필수 문장을 새 카테고리 말투로
...
주제마다 어느 쪽으로 갈지 먼저 정한다. 판단은 **롱폼 5개 관문**
([01L §1](./01L.롱폼_대본작성지침.md))으로 하고, 4개 이상 통과해야 롱폼이다.
못 채운 채 늘리면 늘어진 숏폼이 된다.

| | 숏폼 | 롱폼 |
|---|---|---|
| 길이 | 2~3분 | 8~13분 (표준 11분) |
| 대본 | 1,400자 이내 | 5,200~5,700자 |
| 구조 | 5챕터 | **14블록** (훅+12챕터+회수) |
| 훅 질문 | 1단 | **2단** (방법 + 그다음) |
| 페이오프 | 끝 무렵 | **55% 지점**, 이후 24%가 더 있다 |
...
그대로 쓴다. 컷 수만 25 → 90~110으로 늘고, 해부 쿼터는 비율로 적용한다.

---

| 단계 | 하는 일 | 입력 | 출력 | 문서 | 도구 |
|---|---|---|---|---|---|
| **1** | 대본 작성 | 유물 주제 1개 | 숏폼 5챕터 / 롱폼 14블록 | [01](./%23%20%5B고대유물의%20비밀%5D%20대본%20작성%20전용%20시스템%20지침.txt) · [01L](./01L.롱폼_대본작성지침.md) | — |
...
├─ 01~07 단계 지침
├─ 01L.롱폼_대본작성지침.md  ★ 롱폼 전용 (한강 수중보 편 해부)
├─ 기획/주제100선.md
├─ 자산워터마크.png
│
├─ tools/
