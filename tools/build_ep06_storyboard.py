...
base.SPECS = [
    ...
    spec(
        ...
        ["Raise the question of maker and workshop.", "Stop at the missing signature despite proposed traditions."],
    ...
    spec(
        "7. 확인된 의미", "HISTORICAL_RECONSTRUCTION", "학술해석",
        ...
        ["Show ancient Greeks turning the sky in gears.", "Connect observed heavens, mathematics and craft."],
    ...
    spec(
        ...
        ["Follow the unknown route of the technology.", "Break the route at the wreck rather than invent descendants."],
    ...
    spec(
        ...
        ["Return to the real surviving artifact.", "Hold still for the channel closing line."],
